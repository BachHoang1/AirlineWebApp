...
server.post('/searchDirectResults', async(req, res)=>{
    ...
    try{
        ...
        // console.log(`SELECT * FROM flights WHERE flights.departure_airport LIKE '${depart}' and flights.arrival_airport LIKE '${arrival}' and '${time1}' < flights.scheduled_departure and flights.scheduled_departure < '${time2}';`)
